...
class SignupForm(forms.ModelForm):
	...
	confirm_password = forms.CharField(widget=forms.PasswordInput(attrs={'placeholder': 'ConfirmPassword'}), required=True, label="Confirm your password.")
...
class EditProfileForm(forms.ModelForm):
	...
	first_name = forms.CharField(widget=forms.TextInput(attrs={'placeholder': 'First name'}), max_length=50, required=False)
	last_name = forms.CharField(widget=forms.TextInput(attrs={'placeholder': 'Last name'}), max_length=50, required=False)
	location = forms.CharField(widget=forms.TextInput(attrs={'placeholder': 'location'}), max_length=25, required=False)
	url = forms.URLField(widget=forms.TextInput(attrs={'placeholder': 'url'}), max_length=60, required=False)
	profile_info = forms.CharField(widget=forms.TextInput(attrs={'placeholder': 'bio'}), max_length=260, required=False)
